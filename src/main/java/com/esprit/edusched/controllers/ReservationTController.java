...
/*
    ...
    public  List <Date> getDatesBetween(@PathVariable int idResT){
        ...
        LocalDateTime start = reservationT.getDate_debut();
        LocalDateTime end = reservationT.getDate_fin();
        return getBetween(start,end);
    }

    private List<Date> getBetween(LocalDateTime start, LocalDateTime end){
        List <Date> datesBetween = new ArrayList<>();
        long interval = 24 * 1000 * 60 * 60;
        //long endTime = end.getTime();
        long currentTime= start.getT();
